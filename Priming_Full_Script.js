define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	**/
	...
	/**
	Created by: Davide Rigoni (davide@wearesapience.com). 
	...
	**/
	...
	function epExtension(options)
	{
		...
		var epObj =
		{
			...
			primeDuration : 2000, //Default prime duration
			...
			errorFBDuration : 750, 
			ITIDuration : {min:300, max: 500}, //Can change to a single number. e.g.,  ITIDuration : 400
